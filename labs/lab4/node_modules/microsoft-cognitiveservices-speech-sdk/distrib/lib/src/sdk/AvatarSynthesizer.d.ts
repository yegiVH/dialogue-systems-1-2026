...
import { AvatarConfig, AvatarEventArgs, AvatarSceneConfig, PropertyCollection, SpeechConfig, SpeechSynthesisResult, SynthesisResult, Synthesizer } from "./Exports.js";
/**
...
export declare class AvatarSynthesizer extends Synthesizer {
     ...
     * @returns {Promise<void>} The promise of the void result.
     */
    updateSceneAsync(sceneConfig: AvatarSceneConfig): Promise<void>;
    /**
