...
exports.visemesMachine = void 0;
const xstate_1 = require("xstate");
const blendShapeToFrameParams = (blendShapes) => {
    return blendShapes.reduce((a, v, i) => (Object.assign(Object.assign({}, a), { [blendShapeMap[i + 1]]: v })), {});
};
...
const animationToFrames = (animation) => {
...
exports.visemesMachine = (0, xstate_1.setup)({
    types: {},
}).createMachine({
    context: { queue: [] },
    initial: "Init",
                ...
                VISEME: [
                    {
                        ...
                        actions: [
                            (0, xstate_1.sendParent)(({ event }) => ({
                                ...
                                delay: ({ event }) => (JSON.parse(event.value.animation).FrameIndex * 1000) / 60,
                            }),
                        ],
                    },
                ],
